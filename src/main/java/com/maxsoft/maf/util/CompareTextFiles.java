...
public class CompareTextFiles {
    ...
    {
        BufferedReader reader1 = new BufferedReader(new FileReader(DriverSetup.PROJECT_ROOT + filePath1));
        BufferedReader reader2 = new BufferedReader(new FileReader(DriverSetup.PROJECT_ROOT + filePath2));
